      ...
      <table class="table">
        <thead>
          <tr>
            <th>#</th>
            <th>Task
            <button onclick="location.href='orderbycategory.php?task'">></button>
            </th>
            <th>Status</th>
            <th>Category
              <button onclick="location.href='orderbycategory.php?category'">></button>
            </th>
            <th>
            ...
            <tr>
              ...
              <td colspan="2">
                <center>
                  ...
                  ?>
                  <a href="delete_query_u.php?task_id=<?php echo $elem['task_id'] ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></a>
                </center>
              </td>
            </tr>
          <?php
